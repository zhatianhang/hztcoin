...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Hzcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"learncointools.com", "192.168.195.132"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"hzcointools.com", "testnet-seed.hzcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Hzcoin is probably already running."), addrBind.ToString().c_str());
        else
